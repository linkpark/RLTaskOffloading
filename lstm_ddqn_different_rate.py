...
if __name__ == "__main__":
    ...
    test_case(bandwidth=15.0, lambda_t=lambda_t, lambda_e=lambda_e, log_path=log_path + '-15Mbps')
    test_case(bandwidth=19.0, lambda_t=lambda_t, lambda_e=lambda_e, log_path=log_path + '-19Mbps')