...
def DDQNTO(lambda_t = 1.0, lambda_e = 0.0, logpath="./log/all-graph-latency-optimal",
    ...
    model = LSTMDDQN(hparams=hparams, ob_dim=env.input_dim, gamma=0.99, max_grad_norm=0.5)
