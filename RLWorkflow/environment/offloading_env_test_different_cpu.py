...
def test_case(cpu_frequency, graph_file_path, lambda_t = 0.5, lambda_e = 0.5):
    ...
    print("========= Testing the cpu freqency {} Hz. ============".format(cpu_frequency))
...
if __name__ == "__main__":
    test_case(cpu_frequency=1.0 * 1024 * 1024, graph_file_path="../offloading_data/offload_random15_test/random.15.")
    test_case(cpu_frequency=2.0 * 1024 * 1024, graph_file_path="../offloading_data/offload_random15_test/random.15.")
    test_case(cpu_frequency=3.0 * 1024 * 1024, graph_file_path="../offloading_data/offload_random15_test/random.15.")
    test_case(cpu_frequency=4.0 * 1024 * 1024, graph_file_path="../offloading_data/offload_random15_test/random.15.")
    test_case(cpu_frequency=6.0 * 1024 * 1024, graph_file_path="../offloading_data/offload_random15_test/random.15.")
    test_case(cpu_frequency=8.0 * 1024 * 1024, graph_file_path="../offloading_data/offload_random15_test/random.15.")